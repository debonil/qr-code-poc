package in.gov.indianrail.cris.poc;
...
public class App {
    ...
    public static void main(String[] args) {
        try {
            String textString = args != null ? args[0] : "This is default QR Code, pass argument to change it.";
            generateQRCodeImage(textString, 350, 350, QR_CODE_IMAGE_PATH);
            byte[] bytes = getQRCodeImage(textString, 350, 350);
